...
import com.siyufeng.web.manager.CacheManager;
...
public class GeneratorController {
    ...
    public void useGenerator(@RequestBody GeneratorUseRequest generatorUseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            stopWatch.stop();
            System.out.println("执行脚本完成耗时 = " + stopWatch.getTotalTimeMillis());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @PostMapping("/cache")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public void cacheGeneratorById(GeneratorCacheRequest generatorCacheRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
     ...
     * @return
     */
    public static String getCacheKey(GeneratorQueryRequest generatorQueryRequest) {
